...
public class Ambiente {
	...
	public Set<Coordinate> adiacentiA (Coordinate corrente) {
		if (corrente == null) {
	        throw new IllegalArgumentException("La coordinata corrente non può essere null");
	    }
		...
		for(Coordinate c : adiacenti) {
			if(!this.collideConOstacolo(c) && !this.isFuoriDaBordi(c)) {
	            ...
	            System.out.println("Coordinata scartata (ostacolo o fuori bordi): " + c);
	        }
		}
		System.out.println("Coordinate adiacenti valide: " + possibili);
		return possibili;
