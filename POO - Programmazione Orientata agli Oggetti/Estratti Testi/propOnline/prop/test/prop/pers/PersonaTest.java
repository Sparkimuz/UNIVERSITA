...
public class PersonaTest {
	...
	public void testIdProgressiviPerPersoneStessoTipo() {
		...
		assertEquals("Gli id sono progressivi base 1", 1, new Predicatore(this.ambiente).getId());
	}
	...
	public void testIdProgressiviPerPersoneTipoDiverso() {
		...
		assertEquals("Gli id sono progressivi per tipo base 0", 0, new NonPredicatore(this.ambiente).getId());
		assertEquals("Gli id sono progressivi per tipo base 0", 2, new Predicatore(this.ambiente).getId());
		assertEquals("Gli id sono progressivi per tipo base 1", 1, new NonPredicatore(this.ambiente).getId());
		assertEquals("Gli id sono progressivi per tipo base 1", 3, new Predicatore(this.ambiente).getId());
	}
