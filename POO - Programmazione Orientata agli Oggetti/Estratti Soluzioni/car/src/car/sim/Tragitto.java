...
public class Tragitto {
	...
	@Override
	public int hashCode() {
		return this.getDestinazione().hashCode()+this.getOrigine().hashCode()+this.getAuto().hashCode();
	}

	@Override
	public boolean equals(Object obj) {
		Tragitto that = (Tragitto) obj;
		return this.getDestinazione().equals(that.getDestinazione())&& this.getOrigine().equals(that.getOrigine()) && this.getAuto().equals(that.getAuto());
	}
